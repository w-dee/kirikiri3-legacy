...
public:
	...
	tBMPImageCodecFactory()
	{
		...
		tImageCodecFactoryManager::instance()->Register(tSS<'.','d','i','b'>(), (tImageDecoderFactory*)this);
		tImageCodecFactoryManager::instance()->Register(tSS<'.','b','m','p'>(), (tImageEncoderFactory*)this);
		tImageCodecFactoryManager::instance()->Register(tSS<'.','d','i','b'>(), (tImageEncoderFactory*)this);
	}
};
//---------------------------------------------------------------------------
