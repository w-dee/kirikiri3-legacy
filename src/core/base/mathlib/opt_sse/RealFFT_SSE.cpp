...
STIN void cftmdl(int n, int l, float *a, float *w)
{
...
STIN void cftfsub(int n, float *a, float *w)
{
	int j, j1, j2, j3, l;
...
STIN void rftfsub(int n, float *a, int nc, float *c)
{
	int		j, k, kk, ks, m;
...
STIN void cftbsub(int n, float *a, float *w)
{
