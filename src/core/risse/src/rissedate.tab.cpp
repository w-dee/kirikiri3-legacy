...
#line 94 "rissedate.y"
  ...
  case 6:
#line 101 "rissedate.y"
    {	dp->SetMDay((yyvsp[-3].val));
															dp->SetYear((yyvsp[-2].val)); ;}
    break;

  case 7:
#line 108 "rissedate.y"
    {	dp->SetMDay((yyvsp[-3].val));
															dp->SetYear((yyvsp[-2].val)); ;}
    break;

  case 8:
#line 115 "rissedate.y"
    {	dp->SetMDay((yyvsp[-4].val));
															dp->SetYear((yyvsp[-2].val)); ;}
    break;

  case 9:
#line 123 "rissedate.y"
    {	dp->SetMDay((yyvsp[-4].val));
															dp->SetYear((yyvsp[-1].val)); ;}
    break;

  case 10:
#line 131 "rissedate.y"
    {	dp->SetMDay((yyvsp[-5].val));
															dp->SetYear((yyvsp[-1].val)); ;}
    break;

  case 11:
#line 138 "rissedate.y"
    {	dp->SetMDay((yyvsp[-3].val));
															dp->SetYear((yyvsp[-1].val)); ;}
    break;

  case 12:
#line 145 "rissedate.y"
    {	dp->SetMDay((yyvsp[-3].val));
															dp->SetYear((yyvsp[-1].val)); ;}
    break;

  case 13:
#line 153 "rissedate.y"
  ...
  case 18:
#line 170 "rissedate.y"
    { dp->SetMonth((yyvsp[0].val)); ;}
    break;

  case 21:
#line 180 "rissedate.y"
    { /* TODO: sub-seconds support */ ;}
    break;

  case 23:
#line 188 "rissedate.y"
    {
...
#line 195 "rissedate.y"
  ...
  case 25:
#line 203 "rissedate.y"
    { dp->SetAMPM(false); ;}
    break;

  case 26:
#line 204 "rissedate.y"
    { dp->SetAMPM(true); ;}
    break;

  case 30:
#line 214 "rissedate.y"
    { dp->SetTimeZone((yyvsp[0].val)); ;}
    break;

  case 32:
#line 219 "rissedate.y"
    { dp->SetTimeZoneOffset((yyvsp[0].val)); ;}
    break;

  case 33:
#line 220 "rissedate.y"
    { dp->SetTimeZoneOffset(-(yyvsp[0].val)); ;}
    break;

  case 35:
#line 227 "rissedate.y"
