...
static inline void Risa_VFast_atan2_F1(float v, float &sin, float &cos)
{
	...
	float x1=Risa_VFast_atan2_madd(v, (float)(1.0/(2.0*3.1415926536)), (float)(0.0));
	/* q1=x/2pi reduced onto (-0.5,0.5), q2=q1**2 */
	float q1=Risa_VFast_atan2_nmsub(round(x1), (float)(1.0), x1);
	float q2=Risa_VFast_atan2_madd(q1, q1, (float)(0.0));
	s1= Risa_VFast_atan2_madd(q1,
			Risa_VFast_atan2_madd(q2,
				Risa_VFast_atan2_madd(q2,
					Risa_VFast_atan2_madd(q2, (float)(ss4),
								(float)(ss3)),
									(float)( ss2)),
							(float)(ss1)),
						(float)(0.0));
	c1= Risa_VFast_atan2_madd(q2,
			Risa_VFast_atan2_madd(q2,
				Risa_VFast_atan2_madd(q2, (float)(cc3),
				(float)(cc2)),
			(float)(cc1)),
		(float)(1.0));

	/* now, do one out of two angle-doublings to get sin & cos theta/2 */
	c2=Risa_VFast_atan2_nmsub(s1, s1, Risa_VFast_atan2_madd(c1, c1, (float)(0.0)));
	s2=Risa_VFast_atan2_madd((float)(2.0), Risa_VFast_atan2_madd(s1, c1, (float)(0.0)), (float)(0.0));
	...
	fixmag1=Risa_VFast_atan2_nmsub(s2,s2, Risa_VFast_atan2_nmsub(c2, c2, (float)(2.0)));

	c1=Risa_VFast_atan2_nmsub(s2, s2, Risa_VFast_atan2_madd(c2, c2, (float)(0.0)));
	s1=Risa_VFast_atan2_madd((float)(2.0), Risa_VFast_atan2_madd(s2, c2, (float)(0.0)), (float)(0.0));
	cos=Risa_VFast_atan2_madd(c1, fixmag1, (float)(0.0));
	sin=Risa_VFast_atan2_madd(s1, fixmag1, (float)(0.0));
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
static inline float Risa_Wrap_Pi_F1(float v)
{
	v += M_PI;
