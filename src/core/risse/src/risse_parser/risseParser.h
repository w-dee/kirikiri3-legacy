...
RISSE_DEFINE_TOKEN(T_BEGIN_EMSTRING_LITERAL),
...
RISSE_DEFINE_TOKEN(T_BEGIN_NUMBER          ),
RISSE_DEFINE_TOKEN(T_SYMBOL                ),
RISSE_DEFINE_TOKEN(T_CONSTVAL              ),
RISSE_DEFINE_TOKEN(T_EMSTRING_DOLLAR_S     ),
RISSE_DEFINE_TOKEN(T_EMSTRING_DOLLAR_D     ),
RISSE_DEFINE_TOKEN(T_EMSTRING_AMPERSAND_S  ),
RISSE_DEFINE_TOKEN(T_EMSTRING_AMPERSAND_D  ),
};
