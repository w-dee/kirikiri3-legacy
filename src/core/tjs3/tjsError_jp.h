...
TJS_MSG_DECL(TJSWarnEvalOperator, TJS_W("グローバルでない場所で後置 ! 演算子が使われています(この演算子の挙動はTJS3 version 2.4.1 で変わりましたのでご注意ください)"))
...
TJS_MSG_DECL(TJSCallHistoryIsFromOutOfTJS3Script, TJS_W("[TJSスクリプト管理外]"))
