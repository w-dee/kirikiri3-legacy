...
STIN void cftmdl(int n, int l, float * RISSE_RESTRICT a, float * RISSE_RESTRICT w)
{
...
STIN void bitrv2(int n, int * RISSE_RESTRICT ip, float * RISSE_RESTRICT a)
{
...
STIN void cftbsub(int n, float * RISSE_RESTRICT a, float * RISSE_RESTRICT w)
{
	void cft1st(int n, float * RISSE_RESTRICT a, float * RISSE_RESTRICT w);
...
static void _rdft(int n, int isgn, float * RISSE_RESTRICT a, int * RISSE_RESTRICT ip, float * RISSE_RESTRICT w)
{
	int nw, nc;
	float xi;
